...
class TrainOptions(BaseOptions):
	# cover def initialize() in base_options.py
	def initialize(self):
		...
		# self.parser.add_argument('--with_additional_scene_image', default=False, action='store_true', help="whether to append an extra scene image")	
