...
class TestOptions(BaseOptions):
	def initialize(self):
		...
		self.parser.add_argument('--video1_name', default='accordion/1mCi6eWXVbg.mp4/000025', type=str)
		self.parser.add_argument('--video2_name', default='trumpet/qsciXAjiwF0.mp4/000059', type=str) 
